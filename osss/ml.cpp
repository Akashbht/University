...
// Compare function for qsort (sort by arrival time)
...
// Function to calculate times (CT, TAT, WT, RT) for processes
...
int main() {
    ...
    // Split system and user processes into separate queues
    ...
    // Calculate times for system and user processes
    int current_time = 0;
